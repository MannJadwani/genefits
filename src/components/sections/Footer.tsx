...
export function Footer() {
  return (
    <footer className="py-12 bg-cream border-t border-charcoal/5">
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          {/* Logo & Copyright */}
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-charcoal rounded-lg flex items-center justify-center">
              <MaterialIcon name="checkroom" size={18} className="text-cream" filled />
            </div>
            <div>
              <p className="font-semibold text-charcoal">Genefits</p>
              <p className="text-xs text-charcoal/50">© 2026 Genefits. All rights reserved.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <svg className="w-4 h-4 text-charcoal/60" fill="currentColor" viewBox="0 0 24 24">
